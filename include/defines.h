...
enum consts
{
    ...
    PLAY_AREA_CELLS_WIDTH = 48,
    PLAY_AREA_CELLS_HEIGHT = 48,
    PLAY_AREA_CENTER_WIDTH = PLAY_AREA_CELLS_WIDTH / 2,
    PLAY_AREA_CENTER_HEIGHT = PLAY_AREA_CELLS_HEIGHT / 2,
    VIRTUAL_TILEMAP_WIDTH = PLAY_AREA_CELLS_WIDTH,
    VIRTUAL_TILEMAP_HEIGHT = PLAY_AREA_CELLS_HEIGHT,
    VIRTUAL_TILEMAP_PIX_WIDTH = (PLAY_AREA_CELLS_WIDTH*8),
    VIRTUAL_TILEMAP_PIX_HEIGHT = (PLAY_AREA_CELLS_HEIGHT*8),
