...
-map=<path\file>   =  Load SNASM format map file for use in the debugger. format is: "<16bit_address> <24bit_physical_address> <type> <primary_label>[@<local>]"
-zmap=<path\file>  =  Load Z88DK map file for use in the debugger.
-sound             =  disable sound
